...
class dreamzoneAssistant:
    ...
    def setup_generative_model(self):
        ...
        try:
            ...
            GEMINI_API_KEY = "AIzaSyBnW6WmDokzOhYkkyzAyu6vIZhYuCgEYTE"
            ...
            "intents": [
                {
                    ...
                    "responses": ["Hello! How can I help you today?", "Hi there! What can I do for you?", "Hey! How are you doing?"]
                },
                {
                    "tag": "goodbye",
                    "patterns": ["Bye", "Goodbye", "See you later", "Take care", "Catch you later", "Until next time"],
                    "responses": ["Goodbye! Have a great day!", "See you later!", "Take care!", "Until next time!"]
                },
                {
                    "tag": "thanks",
                    "patterns": ["Thank you", "Thanks", "Thanks a lot", "I appreciate it", "Thank you so much"],
                    "responses": ["You're welcome!", "No problem!", "Happy to help!", "Anytime!", "My pleasure!"]
                },
                {
                    "tag": "name",
                    "patterns": ["What's your name", "Who are you", "What are you called", "Your name"],
                    "responses": ["I'm dream zone, your voice assistant!", "My name is dream zone!", "I'm dream zone, nice to meet you!"]
                },
                {
                    "tag": "help",
                    "patterns": ["Help", "What can you do", "How can you help", "What are your features"],
                    "responses": ["I can chat with you, answer questions, and speak responses aloud. I also support voice input if you have a microphone!", "I'm here to help with conversations and questions. Try asking me anything!", "I can respond to your messages with text and speech. What would you like to know?"]
                },
                {
                    "tag": "weather",
                    "patterns": ["What's the weather", "How's the weather", "Weather today", "Is it raining"],
                    "responses": ["I don't have access to current weather data, but you can check your local weather app or website!", "Sorry, I can't check the weather right now. Try asking me something else!"]
                }
            ]
        }
